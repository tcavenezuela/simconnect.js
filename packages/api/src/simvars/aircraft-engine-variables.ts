...
// data types
import { Int32, SInt32, Float64, SFloat64 } from './simvar-utils';
...
export const AircraftEngineVariables = {
  ...
  'ENGINE CONTROL SELECT': define(`Selected engines (combination of bit flags)`, Mask, SInt32),
  ...
  'ENG FAILED:index': define(`Failure flag for the indexed engine that has failed`, Bool, Int32),
  ...
  'ENG HYDRAULIC PRESSURE:index': define(`The indexed engine hydraulic pressure`, Pounds, Float64),
  'ENG HYDRAULIC QUANTITY:index': define(
    `The indexed enginehydraulic fluid quantity, as a percentage of total capacity`,
    PercentOver100,
    Float64
  ),
  'ENG MANIFOLD PRESSURE:index': define(`The indexed engine manifold pressure`, Inches, Float64),
  ...
  'ENG OIL PRESSURE:index': define(`The indexed engine oil pressure`, Pounds, Float64),
  'ENG OIL QUANTITY:index': define(
    `The indexed engine oil quantity as a percentage of full capacity`,
    PercentOver100,
    Float64
  ),
  'ENG OIL TEMPERATURE:index': define(`The indexed engine oil temperature`, Rankine, Float64),
  'ENG ON FIRE:index': define(`The indexed engine on fire state`, Bool, SInt32),
  'ENG PRESSURE RATIO:index': define(`The indexed engine pressure ratio`, Ratio, Float64),
  ...
  'GENERAL ENG FAILED:index': define(`The indexed engine fail flag`, Bool, Int32),
  ...
  'GENERAL ENG FUEL PRESSURE:index': define(`The indexed engine fuel pressure`, Pounds, SFloat64),
  ...
  'GENERAL ENG OIL PRESSURE:index': define(`The indexed engine oil pressure`, Pounds, SFloat64),
  ...
  'GENERAL ENG RPM:index': define(`The RPM for an indexed engine`, RPM, SFloat64),
  'GENERAL ENG STARTER:index': define(`The indexed engine starter on/off state`, Bool, Int32),
  ...
  'MAX RATED ENGINE RPM': define(`Maximum rated rpm for the indexed engine`, RPM, Float64),
  'NUMBER OF ENGINES': define(`Number of engines (minimum 0, maximum 4)`, Number, Int32),
  'PANEL AUTO FEATHER SWITCH:index': define(
    `Auto-feather arming switch for the indexed engine`,
    Bool,
    Int32
  ),
  'PROP AUTO CRUISE ACTIVE': define(`True if prop auto cruise active`, Bool, Int32),
  ...
  'PROP FEATHER SWITCH:index': define(`Prop feather switch for the indexed engine`, Bool, Int32),
  ...
  'PROP RPM:index': define(`Propeller rpm for the indexed engine`, RPM, SFloat64),
  'PROP SYNC ACTIVE:index': define(`True if prop sync is active the indexed engine`, Bool, Int32),
  'PROP SYNC DELTA LEVER:index': define(
    `Corrected prop correction input on slaved engine for the indexed engine`,
    Position,
    Int32
  ),
  'PROP THRUST:index': define(`Propeller thrust for the indexed engine`, Pounds, Float64),
  ...
  'RECIP ENG FUEL FLOW:index': define(`The indexed engine fuel flow`, PoundsPerHour, SFloat64),
  ...
  'RECIP ENG PRIMER:index': define(`The indexed engine primer state`, Bool, SInt32),
  'RECIP ENG RADIATOR TEMPERATURE:index': define(
    `The indexed engine radiator temperature`,
    Celsius,
    SFloat64
  ),
  'RECIP ENG RIGHT MAGNETO:index': define(` The indexed engine right magneto state`, Bool, SInt32),
  ...
  'TURB ENG AFTERBURNER:index': define(`Afterburner state for the indexed engine`, Bool, Int32),
  ...
  'TURB ENG BLEED AIR:index': define(`Bleed air pressure for the indexed engine`, Pounds, Float64),
  'TURB ENG COMMANDED N1:index': define(
    ` Effective commanded N1 for the indexed turbine engine`,
    Percent,
    SFloat64
  ),
  'TURB ENG CONDITION LEVER POSITION:index': define(` See documentation`, Enum, SInt32),
  ...
  'TURB ENG ITT:index': define(`Retrieve or set the ITT for the indexed engine`, Rankine, SFloat64),
  ...
  'TURB ENG JET THRUST:index': define(`The indexed engine jet thrust`, Pounds, Float64),
  ...
  'TURB ENG N1:index': define(`The indexed turbine engine N1 value`, Percent, SFloat64),
  'TURB ENG N1 LOSS:index': define(
    `This is used to control the N1 loss of the indexed engine`,
    Percent,
    SFloat64
  ),
  'TURB ENG N2:index': define(` The indexed turbine engine N2 value`, Percent, SFloat64),
  'TURB ENG NUM TANKS USED:index': define(
    `Number of tanks currently being used by the indexed engine`,
    Number,
    Int32
  ),
  'TURB ENG PRESSURE RATIO:index': define(`The indexed engine pressure ratio`, Ratio, SFloat64),
  ...
  'TURB ENG TANKS USED:index': define(`Fuel tanks used by the indexed engine`, Mask, Int32),
  ...
  'TURB ENG VIBRATION:index': define(`The indexed turbine engine vibration value`, Number, Int32),
  'TURB MAX ITT': define(
