...
const GENERAL = {
  ...
  'FUEL DUMP ACTIVE': define(`If 1 (TRUE) then the aircraft can dump fuel.`, Bool, Int32),
  ...
  'FUEL PUMP': define(`Currently not used within the simulation.`, Number, Int32),
  ...
  'FUEL WEIGHT PER GALLON': define(`The weight of the fuel, per gallon.`, Pounds, Float64),
  'NEW FUEL SYSTEM': define(
    `Will return 1 (TRUE) if the aircraft is using the modern [FUEL_SYSTEM] or 0 (FALSE) for the legacy [FUEL].`,
    Bool,
    Int32
  ),
  'NUM FUEL SELECTORS': define(`The number of fuel selectors on the aircraft.`, Number, Int32),
