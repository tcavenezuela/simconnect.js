...
// data types
import { Int32, Float64, SFloat64 } from './simvar-utils';
...
const GENERAL = {
  ...
  'DECISION ALTITUDE MSL': define(`Design decision altitude above mean sea level`, Feet, Float64),
  ...
  'IS TAIL DRAGGER': define(`True if the aircraft is a taildragger`, Bool, Int32),
  ...
  'YAW STRING PCT EXTENDED': define(`Yaw string angle as a percentage`, PercentOver100, Float64),
...
const CENTER_OF_GRAVITY = {
  ...
  'STATIC CG TO GROUND': define(`Static CG position with reference to the ground`, Feet, Float64)
};

const INTERACTIVE_POINTS = {
  'INTERACTIVE POINT BANK': define(`Interactive Point orientation: Bank`, Degrees, Float64),
  'INTERACTIVE POINT HEADING': define(`Interactive Point orientation: Heading`, Degrees, Float64),
  ...
  'INTERACTIVE POINT PITCH': define(`Interactive Point orientation: Pitch`, Degrees, Float64),
  ...
  'INTERACTIVE POINT TYPE': define(`The type of interactive point`, Enum, Int32)
};
...
const WEIGHT = {
  ...
  'EMPTY WEIGHT PITCH MOI': define(`Empty weight pitch moment of inertia`, Slugs, Float64),
  'EMPTY WEIGHT ROLL MOI': define(`Empty weight roll moment of inertia`, Slugs, Float64),
  'EMPTY WEIGHT YAW MOI': define(`Empty weight yaw moment of inertia`, Slugs, Float64),
  'MAX GROSS WEIGHT': define(`Maximum gross weight of the aircaft`, Pounds, Float64),
  ...
  'TOTAL WEIGHT PITCH MOI': define(`Total weight pitch moment of inertia`, Slugs, Float64),
  'TOTAL WEIGHT ROLL MOI': define(`Total weight roll moment of inertia`, Slugs, Float64),
  'TOTAL WEIGHT YAW MOI': define(`Total weight yaw moment of inertia`, Slugs, Float64)
};
