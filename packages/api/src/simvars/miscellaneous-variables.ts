...
// data types
import { Int32, SInt32, Float64, SFloat64, String32, String128 } from './simvar-utils';
...
const MISC = {
  ...
  'CRASH FLAG': define(`Flag value that indicates the cause of a crash.`, Enum, Int32),
  'CRASH SEQUENCE': define(`The state of the crash event sequence.`, Enum, Int32),
  'GROUND ALTITUDE': define(`Altitude of surface.`, Meters, Float64),
  'HAND ANIM STATE': define(`What frame of the hand is currently used.`, Enum, SInt32),
  ...
  'REALISM CRASH DETECTION': define(`True indicates crash detection is turned on.`, Bool, Int32),
  ...
  'TRACK IR ENABLE': define(`Returns true if Track IR is enabled or not.`, Bool, SInt32),
  'TOTAL WORLD VELOCITY': define(`Speed relative to the earths center.`, FeetPerSecond, SFloat64),
...
const AMBIENT_WEATHER = {
  ...
  'AMBIENT PRECIP RATE': define(`The current precipitation rate.`, MillimetersOfWater, Float64),
  'AMBIENT PRECIP STATE': define(`The current state of precipitation.`, Mask, Int32),
  ...
  'AMBIENT WIND DIRECTION': define(`Wind direction, relative to true north.`, Degrees, Float64),
  'AMBIENT WIND VELOCITY': define(`Wind velocity.`, Knots, Float64),
  'AMBIENT WIND X': define(`Wind component in East/West direction.`, MetersPerSecond, Float64),
  'AMBIENT WIND Y': define(`Wind component in vertical direction.`, MetersPerSecond, Float64),
  'AMBIENT WIND Z': define(`Wind component in North/South direction.`, MetersPerSecond, Float64),
  'BAROMETER PRESSURE': define(`Barometric pressure.`, Millibars, Float64),
  'SEA LEVEL PRESSURE': define(`Barometric pressure at sea level.`, Millibars, Float64),
