// For more info see: https://docs.flightsimulator.com/html/Programming_Tools/SimVars/Aircraft_SimVars/Aircraft_AutopilotAssistant_Variables.htm

import { define } from './simvar-utils';

// data types
import { Int32, SInt32, Float64, SFloat64, String32, String256 } from './simvar-utils';
...
const AUTOPILOT = {
  'AUTOPILOT AIRSPEED ACQUISITION': define(`Currently not used within the simulation`, Bool, Int32),
  ...
  'AUTOPILOT CRUISE SPEED HOLD': define(`Currently not used within the simulation`, Bool, Int32),
  ...
  'AUTOPILOT FLIGHT DIRECTOR ACTIVE': define(`Flight director active`, Bool, Int32),
  'AUTOPILOT FLIGHT DIRECTOR BANK': define(`Reference bank angle`, Radians, Float64),
  'AUTOPILOT FLIGHT DIRECTOR BANK EX1': define(`Raw reference bank angle`, Radians, Float64),
  'AUTOPILOT FLIGHT DIRECTOR PITCH': define(`Reference pitch angle`, Radians, Float64),
  'AUTOPILOT FLIGHT DIRECTOR PITCH EX1': define(`Raw reference pitch angle`, Radians, Float64),
  ...
  'AUTOPILOT MANAGED INDEX': define(`Currently not used within the simulation`, Number, Int32),
  ...
  'AUTOPILOT MAX SPEED HOLD': define(`Currently not used within the simulation`, Bool, Int32),
  'AUTOPILOT NAV1 LOCK': define(
    `Returns TRUE (1) if the autopilot Nav1 lock is applied, or 0 (FALSE) otherwise`,
    Bool,
    Int32
  ),
  'AUTOPILOT NAV SELECTED': define(`Index of Nav radio selected`, Number, Int32),
  ...
  'AUTOPILOT RPM HOLD': define(`True if autopilot rpm hold applied`, Bool, Int32),
  ...
  'AUTOPILOT SPEED SETTING': define(`Currently not used within the simulation`, Knots, Float64),
  'AUTOPILOT SPEED SLOT INDEX': define(`Index of the managed references`, Number, Int32),
  'AUTOPILOT TAKEOFF POWER ACTIVE': define(`Takeoff / Go Around power mode active`, Bool, Int32),
  ...
  'AUTOPILOT VERTICAL HOLD': define(`True if autopilot vertical hold applied`, Bool, Int32),
  'AUTOPILOT VERTICAL HOLD VAR': define(`Selected vertical speed`, Feet, SFloat64),
...
const AI_AIRCRAFT_PILOT = {
  'AI ANTISTALL STATE': define(`The current state of the AI anti-stall system`, Enum, Int32),
  ...
  'AI CONTROLS': define(`Returns whether the AI control system is enabled or not`, Bool, Int32),
  'AI CURSOR MODE ACTIVE': define(
    `Returns whether the AI cursor mode is active or not`,
    Bool,
    Int32
  ),
  'ATTITUDE BARS POSITION': define(`AI reference pitch reference bars`, PercentOver100, Float64),
  'ATTITUDE CAGE': define(`AI caged state`, Bool, Int32),
  'ATTITUDE INDICATOR BANK DEGREES': define(`AI bank indication`, Radians, Float64),
  'ATTITUDE INDICATOR PITCH DEGREES': define(`AI pitch indication`, Radians, Float64),
...
const FLIGHT_ASSISTANT = {
  ...
  'FLY ASSISTANT NEAREST COUNT': define(`Number of elements in this category`, Number, Int32),
  ...
  'FLY ASSISTANT STALL SPEED': define(`Returns the flight assistant stall speed`, Knots, SFloat64),
