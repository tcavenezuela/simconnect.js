...
// data units
import { Bool, Feet, Number, Degrees, Radians, PercentOver100, RPM, Rankine } from './simvar-utils';
...
const ROTORS = {
  ...
  'ROTOR LATERAL TRIM PCT': define(`The rotor lateral trim percentage.`, PercentOver100, Float64),
  ...
  'ROTOR TEMPERATURE': define(`The main rotor transmission temperature.`, Rankine, Float64),
...
const SLING = {
  'IS ATTACHED TO SLING': define(`Set to true if this object is attached to a sling.`, Bool, Int32),
