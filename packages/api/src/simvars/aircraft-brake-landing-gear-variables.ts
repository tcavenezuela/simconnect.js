...
const BRAKES = {
  ...
  'AUTOBRAKES ACTIVE': define(`Whether or not the AutoBrakes are currently active`, Bool, Int32),
  ...
  'TOE BRAKES AVAILABLE': define(`True if toe brakes are available`, Bool, Int32)
};
...
const LANDING_GEAR = {
  ...
  'GEAR AUX POSITION': define(`Percent auxiliary gear extended`, PercentOver100, SFloat64),
  ...
  'GEAR AUX STEER ANGLE PCT': define(`Aux steer angle as a percentage`, PercentOver100, Float64),
  'GEAR CENTER POSITION': define(`Percent center gear extended`, PercentOver100, SFloat64),
  ...
  'GEAR DAMAGE BY SPEED': define(`True if gear has been damaged by excessive speed`, Bool, Int32),
  'GEAR EMERGENCY HANDLE POSITION': define(`True if gear emergency handle applied`, Bool, Int32),
  ...
  'GEAR IS ON GROUND:index': define(`True if the gear is on the ground`, Bool, Int32),
  'GEAR IS SKIDDING:index': define(`True if the gear is skidding`, Bool, Int32),
  'GEAR LEFT POSITION': define(`Percent left gear extended`, PercentOver100, SFloat64),
  'GEAR LEFT STEER ANGLE': define(
    `Left wheel angle, negative to the left, positive to the right`,
    Radians,
    Float64
  ),
  'GEAR LEFT STEER ANGLE PCT': define(`Left steer angle as a percentage`, PercentOver100, Float64),
  'GEAR POSITION:index': define(`Position of landing gear`, Enum, SInt32),
  'GEAR RIGHT POSITION': define(`Percent right gear extended`, PercentOver100, SFloat64),
  ...
  'GEAR SPEED EXCEEDED': define(`True if safe speed limit for gear exceeded`, Bool, Int32),
  ...
  'GEAR TOTAL PCT EXTENDED': define(`Percent total gear extended`, Percent, Float64),
  'GEAR WARNING:index': define(`Gear warnings`, Enum, Float64),
  'GEAR WATER DEPTH': define(`The depth of the gear in the water`, Centimeters, Float64),
  ...
  'RETRACT FLOAT SWITCH': define(`True if retract float switch on`, Bool, Int32),
  'RETRACT LEFT FLOAT EXTENDED': define(`If aircraft has retractable floats`, Percent, Float64),
  'RETRACT RIGHT FLOAT EXTENDED': define(`If aircraft has retractable floats`, Percent, Float64),
  ...
  'STEER INPUT CONTROL': define(`Position of steering tiller`, PercentOver100, Float64),
