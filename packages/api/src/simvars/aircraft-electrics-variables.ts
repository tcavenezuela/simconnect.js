...
// data units
import { Bool, Percent, PercentOver100, Pounds, Amperes, Volts } from './simvar-utils';
...
const GENERAL_BUSES = {
  ...
  'ELECTRICAL AVIONICS BUS AMPS': define(`Avionics bus current`, Amperes, SFloat64),
  'ELECTRICAL AVIONICS BUS VOLTAGE': define(`Avionics bus voltage`, Volts, SFloat64),
...
const APU = {
  ...
  'APU PCT RPM': define(`Auxiliary power unit RPM, as a percentage`, PercentOver100, Float64),
  'APU PCT STARTER': define(
    `Auxiliary power unit starter, as a percentage`,
    PercentOver100,
    Float64
  ),
  'APU SWITCH': define(`Boolean, whether or not the APU is switched on`, Bool, SInt32),
...
const BATTERIES = {
  ...
  'ELECTRICAL BATTERY BUS AMPS': define(`Battery bus current`, Amperes, SFloat64),
  'ELECTRICAL BATTERY BUS VOLTAGE': define(`Battery bus voltage`, Volts, SFloat64),
...
const CIRCUITS = {
  'CIRCUIT AUTOPILOT ON': define(`Is electrical power available to this circuit`, Bool, Int32),
  'CIRCUIT AUTO BRAKES ON': define(`Is electrical power available to this circuit`, Bool, Int32),
  'CIRCUIT AUTO FEATHER ON': define(`Is electrical power available to this circuit`, Bool, Int32),
  'CIRCUIT AVIONICS ON': define(`Is electrical power available to this circuit`, Bool, Int32),
